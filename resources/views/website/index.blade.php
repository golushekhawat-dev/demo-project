...
@php 
  ...
  <div id="services" class="our-services section">
    <div class="services-right-dec">
      <img src="website/assets/images/services-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="services-left-dec">
        <img src="website/assets/images/services-left-dec.png" alt="">
      </div>
      <div class="row">
...
@php 
        $gallery =App\Models\Services::where('status',1)->get();
        @endphp
      <div class="row">
        <div class="col-lg-12">
          ...
          @foreach($gallery as $g)
            <div class="item">
              <h4>{!!($g->tittle)!!}</h4>
              <div class="icon"><img src="{!!($g->image)!!}" alt=""></div>
              <p>{!!($g->discription)!!}</p>
            </div>
            @endforeach
            ...
            <!-- <div class="item">
              ...
              <div class="icon"><img src="website/assets/images/service-icon-02.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>UI / UX Design and Development</h4>
              <div class="icon"><img src="website/assets/images/service-icon-03.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>Discover &amp; Explore our SEO Tips</h4>
              <div class="icon"><img src="website/assets/images/service-icon-04.png" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
              <h4>Optimizing your websites for Speed</h4>
              <div class="icon"><img src="website/assets/images/service-icon-01.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
  ...
  @php 
        $gallery =App\Models\Abouts::where('status',1)->get();
        @endphp
      ...
      @foreach($gallery as $g)
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{!!($g->image)!!}" alt="Two Girls working together">
          </div>
        </div>
        @endforeach
        <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="website/assets/images/service-icon-01.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="website/assets/images/service-icon-02.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="website/assets/images/service-icon-03.png" alt="">
                    </div>
  ...
  @php 
        $gallery =App\Models\Gallerys::where('status',1)->get();
        @endphp
  <div id="portfolio" class="our-portfolio section">
    <div class="portfolio-left-dec">
      <img src="website/assets/images/portfolio-left-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          @foreach($gallery as $g)
            ...
            <!-- <div class="item">
              <div class="thumb">
                <img src="website/assets/images/portfolio-02.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="website/assets/images/portfolio-03.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="website/assets/images/portfolio-04.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="website/assets/images/portfolio-01.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
  ...
  <div id="pricing" class="pricing-tables">
    <div class="tables-left-dec">
      <img src="website/assets/images/tables-left-dec.png" alt="">
    </div>
    <div class="tables-right-dec">
      <img src="website/assets/images/tables-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
  ...
  <div id="video" class="our-videos section">
    <div class="videos-left-dec">
      <img src="website/assets/images/videos-left-dec.png" alt="">
    </div>
    <div class="videos-right-dec">
      <img src="website/assets/images/videos-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="menu">
                    <div class="active">
                      <div class="thumb">
                        <img src="website/assets/images/video-thumb-01.png" alt="">
                        <div class="inner-content">
                          <h4>Project One</h4>
                          <span>SEO &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="website/assets/images/video-thumb-02.png" alt="">
                        <div class="inner-content">
                    ...
                    <div>
                      <div class="thumb">
                        <img src="website/assets/images/video-thumb-03.png" alt="Marketing">
                        <div class="inner-content">
                          <h4>Project Three</h4>
                          <span>Digital &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="website/assets/images/video-thumb-04.png" alt="SEO Work">
                        <div class="inner-content">
  ...
  <div id="contact" class="contact-us section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 align-self-center">
          <form id="contact" action="{{url('Contacts')}}" method="POST" enctype="multipart/form-data">
          @csrf
            <div class="row">
              <div class="col-lg-12">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="websiteurl" id="website" placeholder="Your Website URL" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <button type="submit" id="form-submit" class="main-button" name="submit">Submit Request</button>
                </fieldset>
              </div>
            </div>
          </form>
    ...
    <div class="contact-dec">
      <img src="website/assets/images/contact-dec.png" alt="">
    </div>
    <div class="contact-left-dec">
      <img src="website/assets/images/contact-left-dec.png" alt="">
    </div>
  </div>

  <div class="footer-dec">
    <img src="website/assets/images/footer-dec.png" alt="">
  </div>
